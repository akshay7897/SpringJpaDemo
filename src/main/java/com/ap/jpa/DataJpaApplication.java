...
public class DataJpaApplication {
	...
	public static void main(String[] args) {
		...
		Student student = studRepo.findById(22).get();
		System.out.println(student);

		// deleting record

		if (studRepo.existsById(444)) {
			studRepo.deleteById(444);
		...
		studRepo.deleteStudent(333);
		System.out.println(delete + " record deleted...");

		// updating record using custom query Integer updatedrecord =
		studRepo.updateStudent(123, "gita");
		System.out.println(updatedrecord + " record is updated....");

		studRepo.insertStudent(111, "akshay", "male", 111);
		System.out.println(" record inserted...");
